                        ...
                        <a href="${html.data[i].url}" class="block-content">
                          <figure class="media-figure media-figure--river">
                            <div class="type-of-article ${html.data[i].type}">
                              <img class="news" src="{{theme.uri}}/img/icon-article-news.png" alt="type-of-article" width="50px">
                              <img class="review" src="{{theme.uri}}/img/icon-article-review.png" alt="type-of-article" width="50px">
                              <img class="walkthrough" src="{{theme.uri}}/img/icon-article-walkthrough.png" alt="type-of-article" width="50px">
                            </div>
