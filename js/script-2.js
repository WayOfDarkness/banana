...
function closeSlideMenu() {
  jQuery("#expanded-menu").animate({right: "-" + slideWidth + "px"}, 200), jQuery(".expanded-menu-button").removeClass("close")
}

function closeAccount() {
  jQuery("#account-dropdown").hasClass("open") && (jQuery("#account-dropdown").removeClass("open"), jQuery(".header-right-container .user-button").removeClass("close"))
}

function closeSearch() {
  jQuery("#search-dropdown").hasClass("open") && (jQuery("#search-dropdown").removeClass("open"), jQuery(".header-right-container .search-button").removeClass("close"))
}

jQuery('a[href^="#"]').on("click", function (e) {
  var o = jQuery(this.getAttribute("href"));
  o.length && (e.preventDefault(), jQuery("html, body").stop().animate({scrollTop: o.offset().top - 87}, 1e3))
}), slideWidth = 400, windowSize = jQuery(window).width(), shrink = jQuery(window).width() - slideWidth, slideMenu = function () {
  jQuery(".expanded-menu-button").click(function () {
    jQuery(".expanded-menu-button").hasClass("close") ? closeSlideMenu() : (jQuery("#expanded-menu").animate({right: "0"}, 200), jQuery(".expanded-menu-button").addClass("close"), windowSize, closeSearch(), closeAccount())
  })
}, jQuery(document).ready(slideMenu), jQuery(document).ready(function () {
  jQuery(".header-right-container .user-button").click(function () {
    jQuery("#account-dropdown").toggleClass("open"), jQuery(".header-right-container .user-button").toggleClass("close"), closeSearch(), closeSlideMenu()
  })
  ...
  jQuery(".region-header-hamburger .icon-search").click(function () {
    jQuery('.region-header-hamburger input[type="search"]').focus()
  })
}), jQuery(document).ready(function () {
  var e;
  jQuery(".menu--main .menu-item a").hover(function () {
    jQuery(".menu-hovered").removeClass("menu-hovered"), jQuery(this).hasClass("is-active") ? jQuery(".is-active").removeClass("menu-remove-hover") : jQuery(this).hasClass("menu-hovered") || (jQuery(this).addClass("menu-hovered"), jQuery(".menu-item .is-active").addClass("menu-remove-hover"))
  }), jQuery(".menu--main .menu-item a").mouseleave(function () {
    e && clearTimeout(e), e = setTimeout(function () {
      jQuery(".menu-hovered").removeClass("menu-hovered"), jQuery(".is-active").removeClass("menu-remove-hover")
    }, 1e3)
  })
  ...
  jQuery(".scrollbar-lt").mCustomScrollbar({
    setWidth: !1,
    setHeight: !1,
    setTop: 0,
    setLeft: 0,
  ...
  jQuery("form").find("input[type=search]").each(function (e) {
    jQuery(this).val() || jQuery(this).attr("placeholder", "")
  })
}), jQuery(document).ready(function () {
  jQuery(".promo-img-thumb a").hover(function () {
    jQuery(this).parentsUntil(".teaser").siblings().find(".page-title a").toggleClass("page-title--hover")
  })
}), jQuery(document).ready(function () {
  jQuery(".spoiler").hover(function () {
  }), jQuery(".spoiler").click(function () {
    jQuery(this).toggleClass("remain")
  })
}), jQuery(function () {
  jQuery(".sort a[href]").filter(function () {
    return this.pathname === window.location.pathname
  }).addClass("current")
}), jQuery(document).ready(function () {
  jQuery(".sort-button").click(function (e) {
    e.preventDefault(), jQuery(".sort-list").toggleClass("open"), jQuery(".sort-button").toggleClass("close")
  })
});
;
jQuery(function () {
  ...
  if (jQuery('#comments').length > 0) {
    ...
    jQuery('#comments').addClass('noselect');


    jQuery('<div id="comments-toggle"><div class="icon-arrow"></div></div>').insertBefore(jQuery('.field--name-field-user-comments'));


    jQuery('#comments-toggle').append('<div class="toggle-comments-num"><span class="disqus-comment-count" data-disqus-identifier="node/' + jQuery('.social-share-comment').attr('data-nid') + '">Comments</span></div>');
    ...
    window.setInterval(function () {
      ...
      if (dummy == null) {
        ...
        jQuery('body').append('<span id="dummydisqus" style="display:none" class="disqus-comment-count" data-disqus-identifier="' + rand + '"></span>');
      } else {

        jQuery('#dummydisqus').attr('data-disqus-identifier', rand);
    ...
    jQuery('#comments-toggle').addClass('noselect');
    commentsDiv.addEventListener('click', toggleComments);

    window.setTimeout(function () {

      if (location.hash.search(/comment-/) == -1) {
        jQuery('.field--name-field-user-comments').css('visibility', 'hidden');
        jQuery('.field--name-field-user-comments').css('height', '1px');
        jQuery('.field--name-field-user-comments').css('overflow', 'hidden');

      }
    }, 1000);

    window.setTimeout(function () {
      jQuery('#comments').css('visibility', 'visible');
    }, 1000);
    ...
    /*
     ...
     jQuery(window).resize(function() {
       ...
       if (jQuery('.field--name-field-user-comments').css('display') == 'none') {
         jQuery('.field--name-field-user-comments').show();
         jQuery('.field--name-field-user-comments').css('height', '1px');
         jQuery('.field--name-field-user-comments').css('overflow', 'hidden');
       }
     });
     function resizeend() {
       if (new Date() - rtime < delta) {
         ...
         timeout = false;
         if (jQuery('.field--name-field-user-comments').css('overflow') == 'hidden') {
           jQuery('.field--name-field-user-comments').hide();
           jQuery('.field--name-field-user-comments').css('height', '');
           jQuery('.field--name-field-user-comments').css('overflow', '');
         }
       }
     }
    ...
    try {
      ...
      document.getElementsByClassName('social-share-comment')[0].addEventListener('click', function () {
        ...
        jQuery('.field--name-field-user-comments').css('visibility', 'visible');
        jQuery('.field--name-field-user-comments').css('height', '');
        jQuery('.field--name-field-user-comments').css('overflow', '');
        jQuery("#comments-toggle").addClass("open");
  ...
  function toggleComments() {
    ...
    if (jQuery('.field--name-field-user-comments').css('visibility') == 'hidden') {
      jQuery('.field--name-field-user-comments').css('height', '');
      jQuery('.field--name-field-user-comments').css('overflow', '');
      jQuery('.field--name-field-user-comments').css('visibility', 'visible');
      ...
      jQuery("#comments-toggle").removeClass("open");
    }
  }
...
jQuery(window).on('load', function () {
  ...
  jQuery('.tweetbyid').each(function () {
    ...
    if (temp.search(/^http/i) > -1) {
      ...
      jQuery(this).attr('data-content', temp);
    ...
    jQuery(this).attr('data-id', temp);


    jQuery(this).text('');

    jQuery(this).show();
    var align = jQuery(this).attr('data-align') == undefined ? 'center' : jQuery(this).attr('data-align');

    twttr.widgets.createTweet(
      temp, jQuery(this).get(0),
      {
        align: align
      })
      .then(function (el) {
        if (!el) {
          ...
          var ref = jQuery('.tweetbyid[data-id="' + temp + '"]');
  ...
  window.setTimeout(function () {
    ...
    jQuery('.tweetbyid').each(function () {
      ...
      if (jQuery(this).find('.EmbeddedTweet').length == 0) {

        //jQuery(this).text(jQuery(this).attr('data-content') + ' is not valid tweet');
      }
    });
...
jQuery(function () {
  ...
  if (jQuery('.toc-anchor').length > 0) {
    html = '<div id="stickynav"><div id="nav-anchor"></div><nav><ul>';
    jQuery('.toc-anchor').each(function () {
      jQuery(this).attr('id', 'tocitem-' + jQuery(this).index('.toc-anchor'));
      html += '<li><a href="#tocitem-' + jQuery(this).index('.toc-anchor') + '">' + jQuery(this).text() + '</a></li>';
    });

    html += '</ul></nav></div>'

    if (jQuery('.ds-left .field--type-ds').length > 0) {
      jQuery(html).insertBefore(jQuery('.ds-left .field--type-ds').eq(0));
    } else {
      jQuery('.ds-left').eq(0).append(jQuery(html));

    }

    window.setTimeout(function () {
      var jQueryroot = jQuery('html, body');
      jQuery('#stickynav a').click(function () {
      ...
      var aChildren = jQuery("#stickynav nav li").children();
      var aArray = [];
      ...
      jQuery(window).scroll(function () {
        ...
        for (var i = 0; i < aArray.length - 1; i++) {
          var theID = aArray[i];
          var theID2 = aArray[i + 1];
          var divPos = jQuery(theID).offset().top - 88;
          var divPos2 = jQuery(theID2).offset().top - 88;

          if (windowPos >= divPos && windowPos < divPos2) {
          ...
          if (windowPos > divPos2) {
            jQuery("a[href='" + theID2 + "']").addClass("nav-active");
          } else {
            jQuery("a[href='" + theID2 + "']").removeClass("nav-active");
          }
        }
      });
    }, 1000);
  ...
  !function (t) {
    ...
    var t, o = "mCustomScrollbar", a = "mCS", n = ".mCustomScrollbar", i = {
      ...
      u = {
        init: function (t) {
          ...
          return e(t).each(function () {
            ...
            if (n.data(a)) {
              ...
              r.live && m(r.liveSelector || e(t).selector), N.call(this, "remove"), k.call(this), B.call(this), n.removeData(a), jquery(this, "mcs"), c.remove(), s.find("img." + d[2]).removeClass(d[2]), l.replaceWith(s.contents()), n.removeClass(o + " _" + a + "_" + i.idx + " " + d[6] + " " + d[7] + " " + d[5] + " " + d[3]).addClass(d[4])
            }
          })
        }
      }, f = function () {
        ...
        l[e] && (clearTimeout(l[e]), jquery(l, e))
      }, p = function (e) {
        ...
        n.advanced.releaseDraggableSelectors && l.add(e(n.advanced.releaseDraggableSelectors)), n.advanced.extraDraggableSelectors && l.add(e(n.advanced.extraDraggableSelectors)), o.bindEvents && (e(document).add(e(!A() || top.document)).unbind("." + i), l.each(function () {
          e(this).unbind("." + i)
        }), clearTimeout(t[0]._focusTimeout), jquery(t[0], "_focusTimeout"), clearTimeout(o.sequential.step), jquery(o.sequential, "step"), clearTimeout(s[0].onCompleteTimeout), jquery(s[0], "onCompleteTimeout"), o.bindEvents = !1)
      }, M = function (t) {
        ...
        function s() {
          clearTimeout(f.step), jquery(f, "step"), Q(t)
        }
        ...
        return t ? (clearTimeout(f[0].autoUpdate), void jquery(f[0], "autoUpdate")) : void o()
      }, V = function (e, t, o) {
