    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0 ; i < data.data.length ; i++) {
                html += `<article class="media media-game media-game media-article">
                            <a href="${data.data[i].url}">
                                ...
                                <div class="media-body">
                                    <h3 class="media-title">
                                        ${convertTitle(data.data[i].title.substring(0,100))}...
                                    </h3>
                                    <p class="media-deck">
                                        ${data.data[i].description.substring(0,170)}...
                                    </p>
...
$('.js-filter-load-page').change(function(e) {
    ...
    option_url = `/api/search?type=article&filter=type**${type}&sortby=${option}`;
